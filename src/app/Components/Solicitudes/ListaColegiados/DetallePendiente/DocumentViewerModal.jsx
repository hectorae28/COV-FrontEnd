...
export default function DocumentViewerModal({ documento, onClose, pendiente, readOnly = false }) {
              ...
              {documento.status && (
                <div className="flex items-center mt-1">
                  ...
                  >
                    ...
                    {documento.status === 'pending' && <Clock size={12} className="mr-1" />}
                  ...
                  {/* Si está aprobado y es de solo lectura */}
                  {documento.status === 'approved' && documento.isReadOnly && (
