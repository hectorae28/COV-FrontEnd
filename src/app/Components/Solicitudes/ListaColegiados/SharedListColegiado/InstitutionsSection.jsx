// SharedListColegiado/InstitutionsSection.jsx
"use client";
    ...
    return (
      ...
      >
        <div className="flex items-center justify-between mb-5 border-b pb-3">
          ...
          {!editandoInstituciones && !readonly ? (
            <button
            ...
            <div className="flex gap-2">
              <button
                onClick={() => {
                  // Revertir cambios
                  setInstituciones(
                    pendiente.instituciones ? [...pendiente.instituciones] : []
                  );
                  setAgregarInstitucion(false);
                  setEditandoInstituciones(false);
                  setCambiosPendientes(false);
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="font-medium text-gray-800">
                        {institucionesList.find(
                          (item) => item.code === institucion.tipo_institucion
                        )?.name ||
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <select
                            ...
                            value={institucion.tipo_institucion || ""}
                            onChange={(e) => handleInstitucionChange(index, e)}
                            className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-200 focus:border-purple-500 appearance-none"
                          >
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="relative">
                      <select
                        name="tipo_institucion"
                        value={nuevaInstitucion.tipo_institucion}
