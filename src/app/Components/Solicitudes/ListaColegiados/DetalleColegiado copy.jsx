...
import {
  ...
  PlusCircle, BarChart3, ChevronLeft, X, Trash2, Eye, Upload, Briefcase
} from "lucide-react"
...
export default function DetalleColegiado({ params, onVolver }) {
          ...
          <div className="md:w-3/4 text-center md:text-left">
            <div className="flex flex-col md:flex-row md:justify-between mb-4">
              ...
              <div className="mt-4 md:mt-0 flex flex-wrap justify-center md:justify-end gap-2">
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${colegiado.solvente ? 'bg-green-100 text-green-800 font-bold' : 'bg-red-100 text-red-800'
                  }`}>
                  {colegiado.solvente ? 'Solvente' : 'Insolvente'}
                </span>

                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${colegiado.estado === "Activo" ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                  }`}>
                  {colegiado.estado}
                </span>

                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${colegiado.carnetVigente ? 'bg-purple-100 text-purple-800' : 'bg-yellow-100 text-yellow-800'
                  }`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-center md:justify-start">
                ...
                <span className="text-gray-700">{colegiado.persona.tipo_identificacion}-{colegiado.persona.identificacion}</span>
              </div>
              ...
              <div className="flex items-start sm:col-span-2 justify-center md:justify-start">
                <MapPin className="text-gray-400 h-5 w-5 mr-2 mt-0.5" />
                <span className="text-gray-700">{colegiado.persona.direccion.referencia}, {colegiado.persona.direccion.estado}</span>
              </div>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        ...
        <div className="p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-[#3C0064] to-[#5E0099] text-white p-6 rounded-lg shadow-md max-w-md mx-auto">
                ...
                <div className="flex mt-4">
                  <div className="mr-4">
                    <div className="w-24 h-24 bg-gradient-to-br from-[#C40180] to-[#7D0053] rounded-md overflow-hidden flex items-center justify-center">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">{colegiado.universidad || "Odontología General"}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 p-4 rounded-md mt-6">
                <h4 className="font-medium text-gray-900 mb-2 text-center">Estado del carnet</h4>
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
                ...
                <div className="mt-4 md:mt-0">
                  <button
                    ...
                    className="cursor-pointer bg-gradient-to-r from-[#C40180] to-[#590248] text-white px-4 py-2.5 rounded-md flex items-center gap-2 hover:from-[#C40180] hover:to-[#C40180] transition-all duration-300 shadow-sm font-medium"
                  >
                    <Upload size={16} />
          ...
          {tabActivo === "chats" && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-gray-900 text-center">Historial de comunicaciones</h3>
                <p className="text-sm text-gray-500 mt-1 text-center">Chats y comunicaciones con el colegiado</p>
              </div>
