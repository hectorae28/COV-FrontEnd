      ...
      {tabsToShow.map((tab) => {
        ...
        return (
          <button
            ...
            className={`cursor-pointer px-3 sm:px-4 py-2.5 font-medium text-sm whitespace-nowrap flex items-center gap-1.5 transition-colors duration-300 relative ${
              activeTab === tab.id
                ? "text-[#D7008A]"
