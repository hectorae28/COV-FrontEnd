...
export default function OdontologosDashboard({ moduleInfo }) {
  // Estado para la información de odontólogos
  const [odontologosInfo, setOdontologosInfo] = useState({
    title: "",
    color: "",
    image: "",
    requisitos: [],
  ...
  useEffect(() => {
    if (tramitesInfo && tramitesInfo.odontologos) {
      setOdontologosInfo({ ...tramitesInfo.odontologos });
    }
  }, []);
  ...
  const handleEditRequisito = (index) => {
    ...
    setNewRequisito(odontologosInfo.requisitos[index]);
  };

  const handleSaveRequisito = (index) => {
    if (newRequisito.trim()) {
      const updatedRequisitos = [...odontologosInfo.requisitos];
  ...
  const handleAddRequisito = () => {
    if (newRequisito.trim()) {
      setOdontologosInfo({
        ...odontologosInfo,
        requisitos: [...odontologosInfo.requisitos, newRequisito]
      });
      setNewRequisito("");
    }
  };
  ...
  const handleEditNota = (index) => {
    ...
    setNewNota(odontologosInfo.notas[index]);
  };

  const handleSaveNota = (index) => {
    if (newNota.trim()) {
      const updatedNotas = [...odontologosInfo.notas];
  ...
  const handleAddNota = () => {
    if (newNota.trim()) {
      setOdontologosInfo({
        ...odontologosInfo,
        notas: [...odontologosInfo.notas, newNota]
      });
      setNewNota("");
    }
  };
  ...
  const handleEditBoton = (index) => {
    ...
    setNewBoton({ ...odontologosInfo.botones[index] });
  };
  ...
  const handleSaveAll = () => {
    console.log("Información de Odontólogos actualizada:", odontologosInfo);
  ...
  return (
    <div className="">
      ...
      <p className="text-gray-600 mb-8">
        Edite la información del trámite de Odontólogos que se muestra en la sección de trámites.
      </p>
      ...
      <div className="bg-white p-6 rounded-xl shadow-md mb-8">
        ...
        <div className="space-y-3 mb-4">
          {odontologosInfo.requisitos.map((requisito, index) => (
            <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
              <div className="flex justify-between items-center p-3 bg-gray-50">
                ...
                <div className="flex items-center gap-1">
                  <button
                    onClick={() => moveItemUp(odontologosInfo.requisitos, index, (newArray) =>
                      setOdontologosInfo({ ...odontologosInfo, requisitos: newArray })
                    )}
                  ...
                  <button
                    onClick={() => moveItemDown(odontologosInfo.requisitos, index, (newArray) =>
                      setOdontologosInfo({ ...odontologosInfo, requisitos: newArray })
                    )}
                    className="text-gray-500 hover:text-gray-700 p-1"
                    title="Mover abajo"
      ...
      <div className="bg-white p-6 rounded-xl shadow-md mb-8">
        ...
        {/* Lista de notas */}
        <div className="space-y-3 mb-4">
          {odontologosInfo.notas && odontologosInfo.notas.map((nota, index) => (
            <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
              <div className="flex justify-between items-center p-3 bg-gray-50">
                <div className="flex-1">
                ...
                <div className="flex items-center gap-1">
                  <button
                    onClick={() => moveItemUp(odontologosInfo.notas, index, (newArray) =>
                      setOdontologosInfo({ ...odontologosInfo, notas: newArray })
                    )}
                    className="text-gray-500 hover:text-gray-700 p-1"
                    title="Mover arriba"
                  >
                  ...
                  <button
                    onClick={() => moveItemDown(odontologosInfo.notas, index, (newArray) =>
                      setOdontologosInfo({ ...odontologosInfo, notas: newArray })
                    )}
                    className="text-gray-500 hover:text-gray-700 p-1"
                    title="Mover abajo"
