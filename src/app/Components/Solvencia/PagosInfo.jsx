"use client";
import { postPago } from "@/api/endpoints/pago";
...
export default function PagosColg({ onPaymentComplete }) {
  ...
  const [paymentAmount, setPaymentAmount] = useState("7.00");
  ...
  /*
    {
            ...
            "tasa_bcv_del_dia": "1.0",
            "solicitud": null,
            "solicitud_solvencia": {
                "modelo_solvencia": 1,
                "costo_solicitud_solvencia": 4
            },
  ...
  const handleSubmit = async (e) => {
    ...
    // const pago = await postPago(session, {
    //   monto: paymentAmount,
    //   moneda: "bs",
    //   num_referencia: referenceNumber,
    //   metodo_de_pago: paymentMethod,
    ...
    form.append("monto", "7");
    form.append("moneda", "bs");
    form.append("num_referencia", "123123");
    form.append("metodo_de_pago", "1");
    form.append("tasa_bcv_del_dia", "1");
    form.append(
      "solicitud_solvencia",
    ...
    const options = {
      method: "POST",
      url: "http://localhost:8000/api/v1/solicitudes/pago/",
      headers: {
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzQ1NDEzOTI4LCJpYXQiOjE3NDUzMjc1MjgsImp0aSI6IjVjNjg1NDM0NmVlYjRhYjY4MGNiYzgxYTdmODFiN2NlIiwidXNlcl9pZCI6Mn0.U60g5MIIxFLm6HxiJQfeln-M2AIeeghhbNI5gYNyj2M",
        "content-type":
    ...
    <div className="w-full">
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-600">
          Complete la información de su pago para finalizar el proceso y renovar
          su Solvencia
        </p>
      </div>
      ...
      <div className="bg-[#f8f9fa] p-6 rounded-xl mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-center">
          ...
          >
            <img src="/assets/Paypal.png" alt="PayPal" className="w-5 h-5" />
          ...
          <div className="mt-6 border-t pt-6">
            {paymentMethod === "bdv" ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <form className="space-y-4 md:pt-12">
