...
export default function DynamicEventForm({
    ...
    // Dividir los campos en dos pasos para mejor experiencia
    ...
    const currentFields = formStep === 0 ? personalFields : customFields;
    ...
    return (
        <div className="w-full max-w-2xl mx-auto bg-white rounded-lg overflow-hidden">
            ...
            <div className="w-full bg-gray-50 px-6 py-3 border-b border-gray-200">
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-medium ${formStep === 0 ? 'bg-[#C40180] text-white' : 'bg-gray-200 text-gray-700'
                            }`}>1</div>
                        <span className="text-sm font-medium">Datos personales</span>
                    </div>
                    <div className="flex-1 mx-2 h-0.5 bg-gray-200"></div>
                    <div className="flex items-center gap-2">
                        <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-medium ${formStep === 1 ? 'bg-[#C40180] text-white' : 'bg-gray-200 text-gray-700'
                            }`}>2</div>
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                {currentFields.map((campo, idx) => (
                                    <div key={`${campo.nombre}-${idx}`} className="space-y-2">
                                        <label
                                        ...
                                        {campo.tipo === "texto" && (
                                            <input
                                                ...
                                                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-[#C40180] focus:border-[#C40180] outline-none"
                                            />
                                        )}
                                        ...
                                        {campo.tipo === "seleccion" && (
                                            <div className="relative">
                                                <select
                                                    ...
                                                    value={formData[campo.nombre] || ""}
                                                    onChange={handleChange}
                                                    className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-[#C40180] focus:border-[#C40180] outline-none appearance-none"
                                                >
                                        ...
                                        {campo.tipo === "archivo" && (
                                            <div className="flex flex-col gap-2">
                                                <div
                                                    className={`flex items-center justify-center w-full h-28 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 ${isDragging ? "border-[#C40180] bg-[#C40180]/5" : "border-gray-300"
                                                        }`}
                                                ...
                                                {selectedFileName[campo.nombre] && (
                                                    <div className="flex items-center gap-1 text-xs text-gray-500 bg-gray-50 p-2 rounded-md border border-gray-200">
                                                        <svg
                    ...
                    <div className="flex gap-3 pt-4">
                        {formStep === 1 && (
                            <button
                                ...
                                className="flex-1 py-2.5 px-4 border border-gray-300 rounded-md font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#C40180] focus:ring-offset-2"
                            >
                                Atrás
                            </button>
                        )}
                        ...
                        {formStep === 0 ? (
                            <button
                                ...
                                className="flex-1 py-2.5 px-4 rounded-md font-medium text-white bg-gradient-to-r from-[#C40180] to-[#590248] hover:from-[#a80166] hover:to-[#470137] focus:outline-none focus:ring-2 focus:ring-[#C40180] focus:ring-offset-2"
                            >
                                Continuar
                            </button>
                        ) : (
                            <button
                                ...
                                disabled={isSubmitting}
                                className="flex-1 py-2.5 px-4 rounded-md font-medium text-white bg-gradient-to-r from-[#C40180] to-[#590248] hover:from-[#a80166] hover:to-[#470137] focus:outline-none focus:ring-2 focus:ring-[#C40180] focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed"
                            >
                                {isSubmitting ?
