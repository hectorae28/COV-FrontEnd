...
export default function EspecialidadesTabs({ props }) {
  const { activeTab, handleTabChange, scrollToTable, especialidadesInfo } =
    props;
        ...
        >
          {especialidades.map(([id, info], index) => (
            <motion.div
              ...
              style={{
                ringColor: activeTab === info.id ? info.color : "transparent",
              }}
              onClick={() => handleTabClick(info.id)}
              ...
              whileHover={{
                scale: activeTab === info.id ? 1.03 : 1.05,
            ...
            >
              ...
              <motion.div
                ...
                initial={{ scale: 1 }}
                animate={{
                  scale: hoveredCard === info.id ? 1.15 : 1.05,
                  filter:
                    hoveredCard === info.id
                      ? "brightness(0.7)"
                      : "brightness(0.6)",
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(to top, ${info.color}CC, ${
                    activeTab === info.id ? "transparent" : "rgba(0,0,0,0.6)"
                  })`,
                }}
              />
              ...
              <motion.div
                ...
                initial={{ y: 5 }}
                animate={{ y: hoveredCard === info.id ? 0 : 5 }}
                transition={{ duration: 0.3 }}
              >
                <motion.h3
                ...
                <motion.p
                  ...
                  initial={{ opacity: 0.7 }}
                  animate={{ opacity: hoveredCard === info.id ? 1 : 0.8 }}
                  transition={{ duration: 0.3 }}
                >
                  {info.description}
                </motion.p>
                ...
                <motion.div
                  ...
                  animate={{
                    opacity: hoveredCard === info.id ? 1 : 0,
                    y: hoveredCard === info.id ? 0 : 10,
                  }}
                  transition={{ duration: 0.3 }}
                >
                  <button
