...
const EventCardWrapper = ({ title, date, location, image, linkText = "Inscripciones clic aquí", link = "#" }) => {
    return (
        <motion.div
        ...
        >
            ...
            >
                ...
                <div className="relative h-48 overflow-hidden flex-shrink-0">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#C40180] to-[#590248] opacity-80"></div>
                    <div className="absolute inset-0">
                        {image ? (
                            <img src={image} alt={title} className="w-full h-full object-cover" />
                        ) : (
                            <div className="w-full h-full flex items-center justify-center">
                                <svg viewBox="0 0 800 800" className="w-32 h-32 text-white opacity-10">
                                    <path fill="currentColor" d="M400 0C179.1 0 0 179.1 0 400s179.1 400 400 400 400-179.1 400-400S620.9 0 400 0zm0 722c-177.2 0-322-144.8-322-322S222.8 78 400 78s322 144.8 322 322-144.8 322-322 322zm22-483h-44v142.2l111.7 111.7 31.1-31.1-98.8-98.8V239z" />
                                </svg>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/70 to-transparent">
                        <h3 className="text-xl md:text-2xl font-bold text-white line-clamp-1">{title}</h3>
                    </div>
                </div>
...
export default function Eventos() {
    ...
    useEffect(() => {
        if (selectedFilter === "todos") {
            ...
            setVisibleEvents(eventsData.filter(event => event.category === selectedFilter));
        }
    }, [selectedFilter]);
        ...
        <div className="flex flex-col min-h-screen bg-gray-50">
            <main className="container mx-auto px-4 py-16 flex-grow">
                ...
                >
                    ...
                    >
                        Mantente al día con nuestras actividades científicas, congresos y eventos académicos
                    </motion.p>
                </motion.div>
                {/* Category Filter */}
                <div className="flex justify-center mb-12">
                    <div className="inline-flex p-1 bg-white rounded-lg shadow-md">
                        {["todos", "COV", "Juegos Nacionales"].map((filter) => (
                            <button
                                key={filter}
                                className={`px-4 py-2 text-sm font-medium rounded-md transition-all ${selectedFilter === filter
                ...
                {visibleEvents.length === 0 && (
                    ...
                    >
                        ...
                        <h3 className="text-xl font-medium text-gray-700">No hay eventos en esta categoría</h3>
                        <p className="text-gray-500 mt-2">Intenta seleccionar otra categoría o vuelve más tarde</p>
                    </motion.div>
                )}
                    ...
                    <div className="max-w-4xl mx-auto p-8 rounded-2xl bg-gradient-to-br from-white to-gray-100 shadow-xl border border-gray-50 relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 opacity-5">
                            <svg className="w-full h-full" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect width="100%" height="100%" fill="url(#smallGrid)" stroke="#C40180" />
                            </svg>
                        </div>
                        <div className="relative z-10">
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">¿Tienes un evento en mente?</h2>
                            <p className="text-gray-600 mb-6">
                                El Colegio de Odontólogos de Venezuela ofrece sus espacios para la realización de eventos científicos y académicos. Contáctanos para conocer más sobre nuestras instalaciones y disponibilidad.
                            </p>
                            <a
                                href="/contacto"
