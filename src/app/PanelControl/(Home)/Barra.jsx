  ...
  return (
    <>
        ...
        <div className="flex items-center space-x-6 lg:mr-12">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="relative md:mr-20">
              <button
                ref={recomendacionesButtonRef}
                className="text-[#41023B] cursor-pointer hover:scale-110 transition-transform duration-200 flex items-center"
                aria-label="Recomendaciones"
                onClick={() => setShowRecomendaciones(!showRecomendaciones)}
              >
                <span className="mr-2 hidden sm:block text-sm font-medium">Recomendaciones</span>
      ...
      <RecomendacionesModal
        ...
        anchorRef={recomendacionesButtonRef}
      />
    </>
  )
}
