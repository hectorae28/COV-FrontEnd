        ...
        <html lang="es-ES">
            <body className={`${montserrat.variable} antialiased`}>
                <div className="bg-[#F9F9F9] h-screen flex-1 relative overflow-hidden">
                    ...
                    {/* Sidebar - responsive */}
                    <aside className={`w-72 bg-gradient-to-t from-[#D7008A] to-[#41023B] text-white fixed h-screen overflow-y-auto z-50 shadow-xl transition-all duration-300 ${sidebarOpen ? 'left-0' : '-left-72'} lg:left-0`}>
                        <AppBar
