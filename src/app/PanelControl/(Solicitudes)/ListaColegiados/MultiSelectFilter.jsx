...
export default function MultiSelectFilter({
    ...
    const removeFilter = (filterId) => {
        setActiveFilters((prev) => {
            ...
            if (filter?.group === "Ubicación") {
                // Limpiar estado seleccionado inmediatamente
                setSelectedEstado(null);
    ...
    const isDistritoCapital = selectedEstado && selectedEstado.value.toLowerCase().includes('distrito');
                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                {selectedEstado ? (
                                                    ...
                                                    <div className="text-center py-4 text-sm text-gray-500 col-span-3">
                                                        Seleccione una ubicación primero para ver 
                                                        {isDistritoCapital 
                                                            ? ' las parroquias ' 
                                                            : ' los municipios '} 
                                                        disponibles
