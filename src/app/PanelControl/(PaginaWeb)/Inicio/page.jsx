...
export default function DashboardPanel() {
  ...
  const renderIcon = (iconName, size = 24, color = "white") => {
    switch (iconName) {
      case "presentation-chart":
        return <GalleryVertical size={size} color={color} />;
      case "settings":
  ...
  const renderDashboardComponent = () => {
    switch (activeModule) {
      case "presentacion":
        return <PresentacionDashboard moduleInfo={moduleInfo} />;
      case "servicios":
        return <ServiciosDashboard moduleInfo={moduleInfo} />;
      case "noticias":
        return <NoticiasDDashboard moduleInfo={moduleInfo} />;
      case "aliados":
        return <AliadosDashboard moduleInfo={moduleInfo} />;
      default:
        return <PresentacionDashboard moduleInfo={moduleInfo} />;
    }
  };
