...
const LineaTiempo = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <motion.div 
        className="relative overflow-hidden bg-white rounded-2xl border border-gray-200 shadow-xl max-h-[calc(100vh-250px)] md:max-h-[calc(100vh-300px)]"
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row h-full">
          ...
          <div className="lg:w-2/5 p-6 md:p-8 flex items-center justify-center bg-gray-50 relative overflow-hidden">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative group mb-6 w-full max-w-xs mx-auto">
                ...
                <div className="text-center">
                  {/* Period with icon */}
                  <div className="flex items-center justify-center gap-4 text-[#590248] mb-4">
                    ...
                    <p className="text-base font-medium">{selected.periodo}</p>
                  </div>
                  
                  {/* Name with animated underline */}
                  <div className="relative">
                    <h2 className="text-xl md:text-2xl font-bold text-gray-800">{selected.nombre}</h2>
                    <motion.div
          ...
          <div className="lg:w-3/5 p-6 md:p-8 flex flex-col rounded-b-xl lg:rounded-bl-none lg:rounded-r-xl">
            {/* Timeline Navigation */}
            <div className="h-full flex flex-col justify-between">
              <div className="flex items-center justify-between mb-6">
                ...
                {/* Improved auto-play button */}
                <motion.button
                  onClick={toggleAutoPlay}
                  className={`flex items-center gap-2 text-sm px-4 py-2 rounded-full transition-all duration-300 shadow-sm ${
                    isAutoPlaying 
              ...
              <div className="relative h-8 bg-gray-100 rounded-full w-full mb-6 overflow-hidden shadow-inner">
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${isCurrent ? "w-5 h-5 bg-white border-3 border-[#C40180] shadow-lg -mt-0.5 z-10" : "w-4 h-4 -mt-0.5"}
              ...
              {/* Year Timeline */}
              <div className="flex justify-between text-xs text-gray-500 w-full mb-8">
              ...
              {/* President Grid Selection with Scrolling */}
              <div 
                ref={gridRef}
                className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3 mb-6 overflow-y-auto custom-scrollbar pr-2"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center p-2">
                        ...
                        <div
                          className={`
                            relative w-14 h-14 rounded-full overflow-hidden mb-2 transition-all duration-300
                            ${isCurrent ? `ring-3 ring-[#590248] shadow-lg` : "ring-1 ring-gray-200"}
                        ...
                        <p
                          className={`
                            text-center text-xs transition-all duration-300 max-w-[60px] truncate
                        ...
                        <div
                          className={`
                            h-0.5 bg-[#590248] mt-1 transition-all duration-300 ease-out
              ...
              <div className="flex items-center justify-center gap-4 mt-auto">
                <motion.button
                  onClick={handlePrev}
                  className="p-3 rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-[#C40180]/50 shadow-sm"
                ...
                <div className="flex flex-col items-center">
                  <div className="text-xs bg-gradient-to-r from-[#C40180] to-[#590248] text-white px-4 py-1.5 rounded-full font-medium shadow-sm">
                    {currentIndex + 1} de {presidentes.length}
                  </div>
                  <div className="text-[10px] text-gray-500 mt-1">
                    {isAutoPlaying ? "Cambiando cada 2 segundos" : "Navegación manual"}
                  </div>
                </div>
      ...
      <style jsx global>{`
        ...
        /* Add border-3 utility since it's not in default Tailwind */
        .border {
          border-width: 1px;
        }
      `}</style>
