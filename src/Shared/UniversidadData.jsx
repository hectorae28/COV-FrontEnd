export const UniversidadData = {
    ...
    Aragua: [
        ...
        { nombre: "Universidad Nacional Experimental Politécnica de la Fuerza Armada", acronimo: "UNEFA" },
        { nombre: "Universidad Bolivariana de Venezuela", acronimo: "UBV" },
        { nombre: "Universidad Politécnica Territorial de Aragua Federico Brito Figueroa", acronimo: "UPTAFBF" },
        { nombre: "Universidad Nacional Experimental Simón Rodríguez", acronimo: "UNESR" },
    ...
    Carabobo: [
        ...
        { nombre: "Universidad Arturo Michelena", acronimo: "UAM" },
        { nombre: "Universidad Nacional Experimental Politécnica de la Fuerza Armada", acronimo: "UNEFA" },
        { nombre: "Universidad Bolivariana de Venezuela", acronimo: "UBV" },
        { nombre: "Universidad Nacional Abierta", acronimo: "UNA" },
    ...
    "Distrito Capital": [
        ...
        { nombre: "Universidad Santa María", acronimo: "USM" },
        { nombre: "Universidad José María Vargas", acronimo: "UJMV" },
        { nombre: "Universidad Nueva Esparta", acronimo: "UNE" },
        { nombre: "Universidad Monteávila", acronimo: "UMA" },
        ...
        { nombre: "Universidad Nacional Experimental Politécnica de la Fuerza Armada", acronimo: "UNEFA" },
        { nombre: "Universidad Bolivariana de Venezuela", acronimo: "UBV" },
        { nombre: "Universidad Nacional Experimental de la Seguridad", acronimo: "UNES" },
        { nombre: "Universidad Nacional Experimental Marítima del Caribe", acronimo: "UMC" },
        { nombre: "Universidad Nacional Experimental Simón Rodríguez", acronimo: "UNESR" },
        { nombre: "Universidad Nacional Abierta", acronimo: "UNA" },
        { nombre: "Universidad Católica Santa Rosa", acronimo: "UCSAR" },
        { nombre: "Universidad Alejandro de Humboldt", acronimo: "UAH" },
    ...
    Falcón: [
        ...
        { nombre: "Universidad Bolivariana de Venezuela", acronimo: "UBV" },
        { nombre: "Universidad Nacional Abierta", acronimo: "UNA" },
        { nombre: "Universidad de Falcón", acronimo: "UDEFA" },
    ...
    Lara: [
        ...
        { nombre: "Universidad Pedagógica Experimental Libertador", acronimo: "UPEL" },
        { nombre: "Universidad Fermín Toro", acronimo: "UFT" },
        { nombre: "Universidad Yacambú", acronimo: "UNY" },
        { nombre: "Universidad Nacional Experimental Politécnica de la Fuerza Armada", acronimo: "UNEFA" },
        { nombre: "Universidad Bolivariana de Venezuela", acronimo: "UBV" },
        { nombre: "Universidad Nacional Abierta", acronimo: "UNA" },
    ...
    Portuguesa: [
        ...
        { nombre: "Universidad Nacional Experimental Politécnica de la Fuerza Armada", acronimo: "UNEFA" },
        { nombre: "Universidad Nacional Abierta", acronimo: "UNA" },
        { nombre: "Universidad Politécnica Territorial de Portuguesa Juan de Jesús Montilla", acronimo: "UPTPJJM" },
        { nombre: "Universidad Fermín Toro", acronimo: "UFT" },
    ...
    Sucre: [
        ...
        { nombre: "Universidad Nacional Experimental Politécnica de la Fuerza Armada", acronimo: "UNEFA" },
        { nombre: "Universidad Nacional Abierta", acronimo: "UNA" },
        { nombre: "Universidad Politécnica Territorial del Oeste de Sucre Clodosbaldo Russian", acronimo: "UPTOSCR" },
        { nombre: "Universidad Politécnica Territorial de Paria Luis Mariano Rivera", acronimo: "UPTPLMR" },
        { nombre: "Universidad Gran Mariscal de Ayacucho", acronimo: "UGMA" },
        { nombre: "Instituto Universitario de Tecnología José Antonio Anzoátegui", acronimo: "IUTJAA" }
    ],
    Táchira: [
    ...
    Zulia: [
        ...
        { nombre: "Universidad Católica Cecilio Acosta", acronimo: "UNICA" },
        { nombre: "Universidad Dr. José Gregorio Hernández", acronimo: "UJGH" },
        { nombre: "Universidad Alonso de Ojeda", acronimo: "UNIOJEDA" },
        { nombre: "Universidad Nacional Experimental Rafael María Baralt", acronimo: "UNERMB" },
        { nombre: "Universidad Bolivariana de Venezuela", acronimo: "UBV" },
        { nombre: "Universidad Nacional Experimental Politécnica de la Fuerza Armada", acronimo: "UNEFA" },
        { nombre: "Universidad Nacional Experimental Sur del Lago Jesús María Semprum", acronimo: "UNESUR" },
        { nombre: "Universidad Nacional Abierta", acronimo: "UNA" },
        { nombre: "Universidad Pedagógica Experimental Libertador", acronimo: "UPEL" },
        { nombre: "Universidad Experimental de la Seguridad", acronimo: "UNES" },
        { nombre: "Universidad Politécnica Territorial de Maracaibo", acronimo: "UPTM" },
        { nombre: "Universidad Panamericana del Puerto", acronimo: "UNIPAP" },
        { nombre: "Instituto Universitario de Tecnología de Maracaibo", acronimo: "IUTM" },
        { nombre: "Instituto Universitario de Tecnología de Cabimas", acronimo: "IUTC" },
        { nombre: "Instituto Universitario Politécnico Santiago Mariño", acronimo: "IUPSM" },
        { nombre: "Instituto Universitario de Tecnología READIC-UNIR", acronimo: "IUTRU" }
    ]
};
